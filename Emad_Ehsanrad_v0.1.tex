...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingSimple
      ...
      \resumeItemListStart
      \resumeItemSimple{Building \textbf{RAG pipelines} and designing \textbf{agentic workflows} to enhance automation and \textbf{intelligent decision-making}.}
        ...
        \resumeItemSimple{Designed an \textbf{onboarding program} for new engineers, ensuring a \textbf{smooth transition} and rapid integration to the team.}
        \resumeItemSimple{Achieved the \href{https://sprinto.com/blog/soc-2-type-2/}{\textbf{SOC 2 Type 2}} certification with the incredible support of both \href{https://www.linkedin.com/company/atom-assurances-services/}{Atom Assurances Services} and \href{https://www.linkedin.com/company/sprinto-com/}{Sprinto}.}
      \resumeItemListEnd
