...
\section{Skills}
  ...
  % \newline
  % \titleWithDescription{Tools}{Kubernetes, Helm, ELK, Docker, GitHub Actions, GitLab CI, Jenkins}\vspace{3pt}
  % \newline
  % \titleWithDescription{Monitoring \& Messaging}{Prometheus, Grafana, OpenTelemetry, Kafka, RabbitMQ}\vspace{3pt}
  % % \hfill
